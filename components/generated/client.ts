...
import type {
	...
	MoviesAddResponse,
	MoviesAddInput,
	MoviesAddResponseData,
	MoviesDeleteResponse,
	MoviesDeleteInput,
	MoviesDeleteResponseData,
	MoviesMovieWithIDResponse,
	MoviesMovieWithIDInput,
	MoviesMovieWithIDResponseData,
	MoviesUpdateResponse,
	MoviesUpdateInput,
	MoviesUpdateResponseData,
...
export type Queries = {
	...
	Movies: {
		input?: undefined;
		response: { data?: MoviesResponse["data"]; error?: ClientOperationErrors };
		requiresAuthentication: false;
		liveQuery: boolean;
	};
	"movies/MovieWithID": {
		input: MoviesMovieWithIDInput;
		response: { data?: MoviesMovieWithIDResponse["data"]; error?: ClientOperationErrors };
		requiresAuthentication: false;
		liveQuery: boolean;
	};
	"incremental/delay": {
...
export type Mutations = {
	"movies/Add": {
		input: MoviesAddInput;
		response: { data?: MoviesAddResponse["data"]; error?: ClientOperationErrors };
		requiresAuthentication: false;
	};
	"movies/Delete": {
		input: MoviesDeleteInput;
		response: { data?: MoviesDeleteResponse["data"]; error?: ClientOperationErrors };
		requiresAuthentication: false;
	};
	"movies/Update": {
		input: MoviesUpdateInput;
		response: { data?: MoviesUpdateResponse["data"]; error?: ClientOperationErrors };
		requiresAuthentication: false;
	};
	"users/update": {
