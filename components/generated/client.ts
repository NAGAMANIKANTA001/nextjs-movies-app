...
export type Queries = {
  ...
  "movies/MovieWithID": {
    ...
    response: {
      data?: MoviesMovieWithIDResponse["data"];
  ...
  "incremental/delay": {
    ...
    response: {
      ...
      error?: OperationErrors["incremental/delay"];
    };
    requiresAuthentication: false;
    liveQuery: boolean;
  };
...
export type Mutations = {
  ...
  "movies/Delete": {
    ...
    response: {
      data?: MoviesDeleteResponse["data"];
      error?: ClientOperationErrors;
    };
    requiresAuthentication: false;
  };
  "movies/Update": {
    ...
    response: {
      data?: MoviesUpdateResponse["data"];
      error?: ClientOperationErrors;
    };
    requiresAuthentication: false;
  };
...
export type Subscriptions = {
  "incremental/data": {
    ...
    response: {
      ...
      error?: OperationErrors["incremental/data"];
    };
    requiresAuthentication: false;
  };
  "users/subscribe": {
  ...
  "incremental/delay": {
    input: IncrementalDelayInput;
    response: {
      data?: IncrementalDelayResponse["data"];
      error?: ClientOperationErrors;
    };
    liveQuery: true;
    requiresAuthentication: false;
